...
class COCODetection(Dataset):
    ...
    def __repr__(self):
        ...
        fmt_str += '    Transforms (if any): {0}'.format(self.img_transform.__name__ if self.img_transform else "No") + '\n'
        fmt_str += '    Target Transforms (if any): ' + (self.coco_annotation_transform.__name__ if self.coco_annotation_transform else "No")
        return fmt_str
